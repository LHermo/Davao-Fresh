...
<nav>
    ...
    <ul>
        ...
        <li <?php if ($_SERVER['PHP_SELF']=='/products.php' ) { 
            echo 'class="active"' ; } ?>>
    ...
    <div class="icons">
    <ul>
        <li <?php if ($_SERVER['PHP_SELF']=='/basket.php' ) { 
                echo 'class="active"' ; } ?>>
                    <a href="basket.php"><img src="assets/shopping-basket.svg" alt="Icon 1"></a>
        </li>
        <li <?php if ($_SERVER['PHP_SELF']=='/account.php' ) { 
                echo 'class="active"' ; } ?>>
                    <a href="account.php"><img src="assets/person-icon.svg" alt="Icon 2"></a>
        </li>
